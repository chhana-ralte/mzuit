<x-diktei>
    <x-container>
        <x-block>
            ...
            <form method="post" action="/dtcourse">
                @csrf
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-md-4">
                        <x-text-input name="code" type="text" class="form-control" value="" required autofocus autocomplete="code" />
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-md-4">
                        <x-text-input id="title" name="title" type="text" class="form-control" value="" required autocomplete="title" />
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-md-4">
                        <x-select name="major" class="form-control">
                            <option value="1">IMJ</option>
                            <option value="0">IMN</option>
                        </x-select>
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-md-4">
                        <x-text-input id="intake" name="intake" type="text" class="form-control" value="" required autocomplete="intake" />
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-md-4">
                        <x-text-input id="faculty" name="faculty" type="text" class="form-control" value="" autocomplete="faculty" />
                ...
                <div class="form-group row p-2">
                    ...
                    <div class="col-md-4">
                        <x-text-input id="contact" name="contact" type="text" class="form-control" value="" autocomplete="contact" />
